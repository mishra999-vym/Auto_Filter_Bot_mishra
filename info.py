...
BOT_TOKEN = environ.get('BOT_TOKEN', "8372507800:AAERB8f9a6I_k3ADuP2-w3UgKFOvfeZPqEs")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002709583482').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002630290227")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ishiqa_db_user:9090ishiqa@cluster0.zpz3o20.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
SHORTENER_API = environ.get("SHORTENER_API", "e63261955287703c6f20561d3f46b9155c0192e9") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "https://linkpays.in/") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "e63261955287703c6f20561d3f46b9155c0192e9")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "https://linkpays.in/") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "e63261955287703c6f20561d3f46b9155c0192e9")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "https://linkpays.in/") # Shortener website for third website
...
OWNER_LNK = environ.get('OWNER_LNK', 't.me/Cinema_Hub_owner') # Owner link for the bot
